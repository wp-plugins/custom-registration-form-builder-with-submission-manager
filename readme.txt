...
Radio box for deciding if the form will be a normal contact form or Registration form to allow visitors to register as users on your WordPress site. Registration form will already have mandatory username and password fields, while contact form will require all fields to be added from forms manager page.
...
1. Download Custom User Registration Form Builder
